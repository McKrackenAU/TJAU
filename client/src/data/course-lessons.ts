  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        title: "Developing Intuition",
        content: `
          <p>The Knight of Wands offers unique opportunities for developing intuition:</p>
          
          <ul>
            <li><strong>Dynamic energy</strong> - Feel the enthusiastic, forward-moving quality this card brings</li>
            <li><strong>Confidence signals</strong> - Notice when bold action and self-assurance are highlighted</li>
            <li><strong>Adventure sensing</strong> - Recognize when passion and exploration are key themes</li>
            <li><strong>Charismatic presence</strong> - Connect with the engaging, magnetic quality of the Knight</li>
          </ul>
          
          <p>When the Knight of Wands appears in your readings, it often signals:</p>
          <ul>
            <li>A time for confident action and bold moves</li>
            <li>Opportunities that require enthusiasm and passion</li>
            <li>The arrival of exciting news or creative projects</li>
            <li>The need for charismatic leadership in a situation</li>
          </ul>
        `
      },
      {
        title: "Intuitive Practice",
        content: `
          <p>To develop your intuitive connection with the Knight of Wands:</p>
          
          <ol>
            <li><strong>Feel the energy</strong> - Sense the passionate, dynamic movement this Knight brings</li>
            <li><strong>Connect with confidence</strong> - What bold, self-assured quality does this image evoke?</li>
            <li><strong>Notice opportunities</strong> - What exciting possibilities are arriving with this energy?</li>
            <li><strong>Sense the adventurous spirit</strong> - Where is courage and exploration needed?</li>
          </ol>
          
          <p>The Knight of Wands invites you to trust your enthusiasm and passionate energy. This card often appears when the path forward requires confidence, charismatic leadership, and the courage to take bold action toward what excites you.</p>
        `
      }
    ],
    exercises: [
      {
        question: "What physical sensation most closely aligns with the Knight of Wands' energy?",
        options: [
          "A sense of heaviness and grounding in the lower body",
          "A feeling of emotional fluctuation and vulnerability",
          "A surge of energy, warmth, and excitement in the chest and upper body",
          "A cool clarity and sharpness in the head"
        ],
        correctAnswer: 2,
        explanation: "A surge of energy, warmth, and excitement in the chest and upper body most closely aligns with the Knight of Wands' energy. This physical sensation reflects the card's fundamental qualities of enthusiasm, passion, and dynamic action. When reading intuitively, this uplifting, activating feeling can help you recognize when the Knight's bold, adventurous energy is relevant to the situation."
      },
      {
        question: "When the Knight of Wands appears in a reading about a creative project, what intuitive insight is most aligned with its energy?",
        options: [
          "Careful planning and methodical development are needed",
          "Bold action, enthusiasm, and confident leadership will move things forward",
          "Emotional depth and sensitivity should be the primary focus",
          "Analytical thinking and critical assessment are required"
        ],
        correctAnswer: 1,
        explanation: "When the Knight of Wands appears in a reading about a creative project, the intuitive insight most aligned with its energy is that bold action, enthusiasm, and confident leadership will move things forward. This insight captures the Knight's essential qualities of passionate pursuit and dynamic energy. Rather than suggesting careful planning, emotional depth, or analytical thinking as primary approaches, the Knight of Wands indicates that enthusiastic engagement and charismatic direction will create momentum and inspire progress."
      }
    ],
    summary: "The Knight of Wands represents passionate energy, enthusiastic pursuit, and bold action. This card embodies the qualities of adventure, confident movement, and charismatic leadership. When developing intuitive reading skills, the Knight of Wands invites you to trust your excitement, recognize opportunities for dynamic action, and connect with the transformative power of pursuing goals with determination and charm.",
    additionalResources: [
      {
        title: "Cultivating Confidence",
        description: "Techniques for developing the bold self-assurance needed to pursue passionate goals."
      },
      {
        title: "Creative Momentum",
        description: "Understanding how enthusiasm and dynamic energy can overcome obstacles and inspire others."
      }
    ]
  },
  {
...
export const minorArcanaLessons: LessonContent[] = [
  ...
  {
    id: "minor-53",
    title: "The Knight of Swords: Intellectual Action and Direct Communication",
    description: "Explore mental clarity, direct communication, and decisive action through the Knight of Swords.",
    cardId: "sn",
    sections: [
      {
        title: "The Knight of Swords: Overview",
        content: `
          <p>Following the intellectual curiosity of the Page of Swords, the Knight of Swords represents focused mental action—bringing swift movement, direct communication, and the decisive clarity needed to pursue truth with determination and strategic thinking.</p>
          
          <p>This card typically depicts a knight in armor, charging forward on a horse at full gallop with a sword held high, often against a turbulent, cloudy sky. The dynamic movement and focused determination of the figure symbolize the power of directed mental energy and the pursuit of clarity through action.</p>
          
          <p>The Knight of Swords asks us to consider:</p>
          <ul>
            <li>What truth or idea am I ready to pursue with focused determination?</li>
            <li>Where might direct communication or honest expression be needed?</li>
            <li>How can I bring more mental clarity and decisive action to a situation?</li>
            <li>What intellectual challenges am I prepared to confront directly?</li>
          </ul>
        `
      },
      {
        title: "Key Meanings and Symbols",
        content: `
          <p>The Knight of Swords contains powerful symbols that help us understand its meaning:</p>
          
          <ul>
            <li><strong>The charging horse</strong> - Represents swift mental movement and decisive action</li>
            <li><strong>The raised sword</strong> - Symbolizes clarity of thought and direct communication</li>
            <li><strong>The armor</strong> - Indicates intellectual protection and mental preparation</li>
            <li><strong>The cloudy sky</strong> - Shows the realm of thought and the air element in motion</li>
          </ul>
          
          <p>In readings, the Knight of Swords suggests:</p>
          <ul>
            <li>Mental clarity and focused determination</li>
            <li>Direct communication and honest expression</li>
            <li>Swift, decisive action based on clear thinking</li>
            <li>The courage to pursue truth and confront challenges</li>
            <li>Strategic thinking and problem-solving</li>
          </ul>
        `
      },
      {
        title: "Working with the Knight of Swords",
        content: `
          <p>When the Knight of Swords appears in your reading, consider these reflective questions:</p>
          
          <ul>
            <li>Where do I need to communicate more directly and honestly?</li>
            <li>What truth am I ready to pursue with determination?</li>
            <li>How can I bring more mental clarity to my current challenges?</li>
            <li>Where might decisive action create a breakthrough?</li>
          </ul>
          
          <p>Actions to take when working with Knight of Swords energy:</p>
          <ul>
            <li>Express your thoughts and ideas clearly and directly</li>
            <li>Research and gather facts to support your position</li>
            <li>Make decisions based on clear thinking rather than emotions</li>
            <li>Approach intellectual challenges with courage and focus</li>
            <li>Use strategic thinking to solve complex problems</li>
          </ul>
        `
      }
    ],
    exercises: [
      {
        question: "What element is associated with the Knight of Swords?",
        options: [
          "Earth - representing stability and manifestation",
          "Water - representing emotions and intuition",
          "Air - representing intellect, communication, and mental clarity",
          "Fire - representing passion and creativity"
        ],
        correctAnswer: 2,
        explanation: "The element associated with the Knight of Swords is Air. As with all cards in the Swords suit, the Knight of Swords embodies the airy qualities of intellect, communication, and mental clarity. This element reflects the card's themes of direct expression, swift mental movement, and decisive action based on clear thinking."
      },
      {
        question: "What distinguishes the Knight of Swords from the other Knights?",
        options: [
          "A focus on emotional connection and intuitive flow",
          "A focus on practical reliability and methodical progress",
          "A focus on creative passion and enthusiastic pursuit",
          "A focus on mental clarity, direct communication, and decisive action"
        ],
        correctAnswer: 3,
        explanation: "What distinguishes the Knight of Swords from the other Knights is a focus on mental clarity, direct communication, and decisive action. While the Knight of Cups focuses on emotional flow and intuitive connection, the Knight of Pentacles on reliable, methodical progress, and the Knight of Wands on passionate, creative pursuit, the Knight of Swords is devoted to direct expression, swift mental movement, and the courageous pursuit of truth through clear thinking and focused determination."
      },
      {
        question: "What potential challenge should one be aware of when working with Knight of Swords energy?",
        options: [
          "Excessive passivity and indecision",
          "Over-caution and resistance to change",
          "Impulsiveness, harshness, or rushing without consideration",
          "Materialism and excessive focus on security"
        ],
        correctAnswer: 2,
        explanation: "A potential challenge to be aware of when working with Knight of Swords energy is impulsiveness, harshness, or rushing without full consideration. When the Knight's positive qualities of mental clarity and decisive action become unbalanced, they can manifest as rushing into situations without proper preparation, communicating in ways that are unnecessarily harsh or cutting, or making decisions that prioritize speed over wisdom. The immature expression of this energy might value winning arguments over finding truth."
      }
    ],
    summary: "The Knight of Swords represents mental clarity, direct communication, and decisive action in pursuit of truth. It embodies the courage to express ideas honestly, the swift mental movement needed to address intellectual challenges, and the focused determination that transforms clear thinking into strategic action. This card invites us to pursue truth with courage, to communicate with clarity and directness, and to bring decisive mental energy to situations that require breakthrough thinking and honest expression.",
    additionalResources: [
      {
        title: "Strategic Problem-Solving",
        description: "Approaches to addressing complex challenges with clarity and decisive action"
      },
      {
        title: "The Art of Direct Communication",
        description: "How to express ideas clearly while maintaining respect and consideration"
      }
    ]
  },
  {
    ...
    sections: [
      {
        ...
        content: `
          ...
          <ul>
            ...
            <li>Direct, truthful communication</li>
            <li>Swift action based on clear thought</li>
            <li>Courageous pursuit of ideas and truths</li>
            <li>Strategic thinking and problem-solving</li>
          </ul>
          <p>The Knight of Swords typically appears as a figure on horseback, often charging forward with sword drawn - representing the movement of ideas, the power of decisive mental action, and the courage to speak truth directly.</p>
        `
      },
      {
        title: "Intuitive Reading Practice",
        content: `
          <p>When practicing intuitive reading with the Knight of Swords, focus on these elements:</p>
          <ul>
            <li><strong>Movement and Direction</strong>: Notice which way the Knight is facing or moving. What direction is the energy flowing in the situation?</li>
            <li><strong>The Sword Position</strong>: Is it raised for action, pointed forward for direction, or in another position? What does this suggest about communication or intellectual focus?</li>
            <li><strong>The Sky/Background</strong>: Often turbulent in this card, what emotional or mental atmosphere does it evoke in you?</li>
            <li><strong>Horse's Movement</strong>: The horse represents instinctual energy carrying the rational mind. How controlled or wild is this movement, and what does that suggest?</li>
          </ul>
          <p>As you connect with the Knight of Swords intuitively, you might feel a sense of mental clarity, a surge of courage to speak your truth, or an impulse toward decisive action based on your convictions.</p>
        `
      },
      {
        title: "Integrating Intuitive Insights",
        content: `
    ...
    exercises: [
      {
        ...
        options: [
          "Patient reflection",
          "Emotional depth",
          "Mental clarity and direct action",
          "Material stability"
        ],
        correctAnswer: 2,
        explanation: "The Knight of Swords embodies mental clarity and direct action - the focused movement of ideas and truth-seeking."
      },
      {
        question: "When reading the Knight of Swords intuitively, which element is most important to notice?",
        options: [
          "The background colors and their emotional resonance",
          "The direction of movement and the position of the sword",
          "The clothing and physical appearance of the Knight",
          "The symbolic meaning of each cloud in the sky"
        ],
        correctAnswer: 1,
        explanation: "The direction of movement and the position of the sword are key intuitive elements that reveal the flow of mental energy and communication in the situation."
      },
      {
        question: "Which situation might the Knight of Swords most intuitively represent?",
        options: [
          "A period of quiet reflection and emotional healing",
          "Building material security through careful planning",
          "Taking decisive action based on clear thinking and direct communication",
          "Nurturing relationships through empathetic listening"
        ],
        correctAnswer: 2,
        explanation: "The Knight of Swords most intuitively represents taking decisive action based on clear thinking and direct communication."
      }
    ],
    summary: "The Knight of Swords represents the energy of mental clarity, direct communication, and decisive action. Through intuitive reading of this card, we learn to recognize the power of focused intellectual movement, the courage to pursue and speak truth, and the importance of strategic thinking in our approach to life's challenges.",
    additionalResources: [
      {
        title: "Developing Mental Clarity",
        description: "Practices for cultivating the clear thinking represented by the Knight of Swords"
      },
      {
        title: "Effective Communication Techniques",
        description: "Methods for expressing ideas with the directness and clarity of the Knight of Swords"
      }
    ]
  },
  {
    ...
    sections: [
      {
        ...
        content: `
          <p>After the intellectual curiosity of the Page of Swords and the direct, decisive action of the Knight of Swords, the Queen of Swords represents the refinement of mental clarity into perceptive wisdom—bringing objective discernment, intellectual independence, and the ability to see truth with clear-eyed compassion.</p>
          
          <p>This card typically depicts a seated female figure on a throne, often holding her sword upright, pointing toward the sky. Her posture is usually straight and dignified, with her gaze direct and penetrating. The Queen's throne may be adorned with butterflies (representing transformation) and clouds (representing the realm of thought).</p>
        `
      },
      {
        title: "Key Intuitive Elements",
        content: `
          <p>When reading the Queen of Swords intuitively, focus on these key elements:</p>
          
          <ul>
            <li><strong>The upward-pointing sword</strong>: Representing clarity of mind and the pursuit of higher truth</li>
            <li><strong>The direct gaze</strong>: Symbolizing perceptiveness and the ability to see through illusion</li>
            <li><strong>The clouds in the background</strong>: The realm of thought and mental activity</li>
            <li><strong>The butterfly decorations</strong>: Transformation through intellectual growth</li>
            <li><strong>The extended hand</strong>: Often open, suggesting receptivity to truth</li>
          </ul>
          
          <p>The Queen of Swords embodies the qualities of clear perception, intellectual independence, compassionate truth-telling, and wisdom born of experience—often including past pain that has been transformed into understanding.</p>
        `
      },
      {
        title: "Intuitive Reading Practice",
        content: `
          <p>When this card appears in a reading, intuitively consider:</p>
          
          <ul>
            <li><strong>Where in your life are you being called to see with greater clarity?</strong> The Queen offers the gift of seeing things as they truly are.</li>
            <li><strong>How can you communicate truth with both directness and compassion?</strong> The Queen cuts through confusion without unnecessary harshness.</li>
            <li><strong>What boundaries need to be established or maintained?</strong> The Queen is skilled at creating appropriate separation.</li>
            <li><strong>How can past challenges be transformed into wisdom?</strong> The Queen often represents someone who has grown stronger through difficulty.</li>
          </ul>
          
          <p>As you connect with this card, you might intuitively feel a sense of mental clarity, a compassionate detachment that allows for clear seeing, or the strength that comes from integrating painful experiences into wisdom.</p>
        `
      }
    ],
    exercises: [
      {
        question: "Which quality best captures the intuitive essence of the Queen of Swords?",
        options: [
          "Emotional nurturing and sensitivity",
          "Clear perception combined with compassionate discernment",
          "Material abundance and physical comfort",
          "Creative passion and inspiration"
        ],
        correctAnswer: 1,
        explanation: "The Queen of Swords embodies clear perception combined with compassionate discernment—the ability to see truth clearly while maintaining wisdom and compassion."
      },
      {
        question: "What past experience is often associated with the Queen of Swords energy?",
        options: [
          "Uncomplicated happiness and joy",
          "Material success and abundance",
          "Pain or loss that has been transformed into wisdom",
          "Creative achievement and recognition"
        ],
        correctAnswer: 2,
        explanation: "The Queen of Swords often represents someone who has experienced pain or loss and transformed it into wisdom and clarity."
      },
      {
        question: "When the Queen of Swords appears in a reading, it might intuitively suggest the need for:",
        options: [
          "Greater emotional expressiveness and vulnerability",
          "More logical thinking and clear boundaries",
          "Increased material focus and practical planning",
          "Enhanced creativity and artistic expression"
        ],
        correctAnswer: 1,
        explanation: "The Queen of Swords suggests the need for more logical thinking and clear boundaries—seeing situations with objectivity and establishing appropriate separation when necessary."
      }
    ],
    summary: "The Queen of Swords embodies clear perception, intellectual independence, and compassionate truth-telling. Through her energy, we learn to see situations objectively, communicate with both directness and compassion, establish appropriate boundaries, and transform difficult experiences into wisdom that can benefit ourselves and others.",
    additionalResources: [
      {
        title: "Developing Clear Perception",
        description: "Practices for cultivating the Queen of Swords' ability to see truth clearly"
      },
      {
        title: "Compassionate Communication",
        description: "Techniques for expressing difficult truths with the Queen's balance of directness and compassion"
      }
    ]
  },
  {
...
// Create a completely new array for the Minor Arcana track
// This is a complete rebuild to fix issues with missing cards and sequence problems
const rebuiltMinorArcanaLessons = (() => {
  // Start with a fresh array for the lessons in proper sequence
  const orderedLessons: LessonContent[] = [];
  
  // Step 1: Get the introduction lesson
  const introLesson = minorArcanaLessons.find(lesson => lesson.id === "minor-1");
  if (introLesson) {
    orderedLessons.push(introLesson);
  }
  
  // Step 2: Create a mapping to find lessons easily by cardId
  // This will contain both original Minor Arcana lessons and ones we'll borrow from Intuitive Reading
  const lessonsByCardId: Record<string, LessonContent> = {};
  
  // First map all existing Minor Arcana lessons
  minorArcanaLessons.forEach(lesson => {
    if (lesson.id !== "minor-1") { // Skip intro
      // To avoid duplicates with same cardId, give preference to cards with more appropriate IDs
      if (!lessonsByCardId[lesson.cardId] || (lesson.id.includes("wands") || lesson.id.includes("cups") || lesson.id.includes("pentacles") || lesson.id.includes("swords"))) {
        lessonsByCardId[lesson.cardId] = lesson;
      }
    }
  });
  
  // Step 3: Look for missing cards in the Intuitive Reading track and create copies
  const allCardIds = [
    // Wands
    'w1', 'w2', 'w3', 'w4', 'w5', 'w6', 'w7', 'w8', 'w9', 'w10', 'wp', 'wn', 'wq', 'wk',
    // Cups
  ...
  // Find any missing cards and get substitutes from the Intuitive Reading track
  const missingCards: string[] = [];
  allCardIds.forEach(cardId => {
    if (!lessonsByCardId[cardId]) {
      missingCards.push(cardId);
      
      // Look for this card in the Intuitive Reading track
      const intuitiveLesson = intuitiveReadingLessons.find(lesson => lesson.cardId === cardId);
      if (intuitiveLesson) {
        // Create a copy with a unique ID for the Minor Arcana track
        const suit = cardId[0];
        const rank = cardId.substring(1);
        const suitName = { 'w': 'wands', 'c': 'cups', 'p': 'pentacles', 's': 'swords' }[suit] || 'unknown';
        const rankName = { 
        ...
        // Create a new unique ID that won't conflict
        const newId = `minor-${suitName}-${rankName}`;
        
        // Create the substitute lesson
        lessonsByCardId[cardId] = {
          ...intuitiveLesson,
          id: newId,
          cardId: cardId
        };
      } else {
        console.log(`CRITICAL: No lesson found for ${cardId} in either Minor Arcana or Intuitive Reading`);
      }
    }
  });
  
  // Step 4: Add cards in the correct suit order
  // Add introduction first (already done above)
  
  // Explicitly define a unique ID for each lesson using consistent naming
  function createOrderedSequence(suit: string, cardIds: string[]) {
    return cardIds.map((cardId, index) => {
      const lesson = lessonsByCardId[cardId];
      if (lesson) {
        // Fix the IDs to ensure consistency and prevent duplicates
        const rankLetter = cardId.substring(1);
        const rankName = { 
          '1': 'ace', '2': 'two', '3': 'three', '4': 'four', '5': 'five', 
          '6': 'six', '7': 'seven', '8': 'eight', '9': 'nine', '10': 'ten',
          'p': 'page', 'n': 'knight', 'q': 'queen', 'k': 'king' 
        ...
        // Create a completely new lesson copy with a standardized ID
        const newId = `minor-${suit}-${rankName}`;
        
        return {
          ...lesson,
          id: newId, // Always override with consistent ID
          cardId: cardId // Ensure cardId is correct
        };
      }
      return null;
  ...
  const pentaclesLessons = createOrderedSequence('pentacles', ['p1', 'p2', 'p3', 'p4', 'p5', 'p6', 'p7', 'p8', 'p9', 'p10', 'pp', 'pn', 'pq', 'pk']);
  const swordsLessons = createOrderedSequence('swords', ['s1', 's2', 's3', 's4', 's5', 's6', 's7', 's8', 's9', 's10', 'sp', 'sn', 'sq', 'sk']);
  
  // Add all lessons in the correct order
  orderedLessons.push(...wandsLessons);
  orderedLessons.push(...cupsLessons);
  orderedLessons.push(...pentaclesLessons);
  orderedLessons.push(...swordsLessons);
  
  // Log the final sequence for verification
  console.log(`Rebuilt Minor Arcana lessons: ${orderedLessons.length} total`);
  console.log("Sequence verification:");
  orderedLessons.forEach((lesson, index) => {
    console.log(`${index + 1}. ${lesson.id} - Card: ${lesson.cardId}`);
  });
