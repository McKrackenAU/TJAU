...
export const minorArcanaLessons: LessonContent[] = [
  ...
  // EIGHT OF WANDS
  {
    ...
    exercise: {
      title: "Aligning with Swift Energy",
      description: "This exercise helps you prepare for and navigate periods of acceleration.",
      instructions: `
        <p>The Eight of Wands teaches us about the quality of focus and preparation needed during times of swift movement and opportunity. Complete the following steps:</p>
        
        <ol>
          <li>Identify an area of your life that feels stagnant or needs forward momentum.</li>
          <li>Create a "launch preparation list" - what would need to be in place for rapid progress to occur?</li>
          <li>Consider what obstacles you could clear now, before acceleration begins.</li>
          <li>Practice making quick, aligned decisions by setting a timer for 2 minutes when facing minor choices today.</li>
          <li>Reflect on past experiences of "being in the flow" - what helped you maintain focus and direction when events moved quickly?</li>
        </ol>
        
        <p>The key insight of this exercise is recognizing that while we can't always control when momentum builds, we can prepare ourselves to ride the wave effectively when it arrives.</p>
      `
    },
    quiz: [
      {
